...
This document will provide a detailed description of the integration of the Flux Tasks API, helping you easily integrate and fully utilize the powerful features of this API. With the Flux Tasks API, you can easily query the execution status of tasks from the Flux Images Generation API.
...
The returned result contains multiple fields, among which `items` includes the specific details of batch image tasks, and each image task's specific information is the same as the fields mentioned above.
